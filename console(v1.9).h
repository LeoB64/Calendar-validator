...
//#define _getch()  (char) _getwch()  // patch temporaire pour contourner un bug de Windows
//#define _getche() (char) _getwche() // patch temporaire pour contourner un bug de Windows
